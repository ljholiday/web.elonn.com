...
$checks = [
    ...
    'Workspace results have panel controls for collapse close and clear' => str_contains($webRenderer, 'workspace-results-panel__bar')
        && str_contains($webRenderer, "barClass: 'workspace-results-panel__bar'")
        ...
        && str_contains($webRenderer, "headerDataset: 'workspaceResultsTitle'")
        && str_contains($webRenderer, "titleDataset: 'workspaceResultsTitle'")
        && str_contains($webRenderer, "dataset: 'workspaceResultsClear'")
        && str_contains($webRenderer, "closeDataset: 'workspaceResultsClose'")
        && str_contains($webRenderer, 'options.emptyVisible')
        ...
        && str_contains($webRuntime, 'clearWorkspaceResults')
        && str_contains($webRuntime, 'workspaceResultsClosed = false;')
        ...
        && str_contains($webRuntime, "String(placement.type || '') !== 'workspace'")
